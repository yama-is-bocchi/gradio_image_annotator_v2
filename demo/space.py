...
<a href="https://pypi.org/project/gradio_image_annotation_v2/" target="_blank"><img alt="PyPI - Version" src="https://img.shields.io/pypi/v/gradio_image_annotation_v2"></a>  
</div>
...
```bash
pip install gradio_image_annotation_v2
```
...
```python
import gradio as gr
from gradio_image_annotation_v2 import image_annotator
import numpy as np
